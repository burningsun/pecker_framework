...
{
	typedef PFX_SQE_CMAT_TYPE::matrix_alg_t matrix_alg_t;
	matrix_alg_t::matrix_t mat = matrix_reference (this->m_mat);
...
{
	typedef PFX_SQE_CMAT_TYPE::matrix_alg_t matrix_alg_t;
	matrix_alg_t::matrix_t mat_this = matrix_reference (this->m_mat);
	matrix_alg_t::matrix_t mat_other = matrix_reference (mat->m_mat);
...
PFX_SQE_CMAT_TYPE::matrix_alg_t::cw_buffer_t* exten_buffer) const
{
	...
	typedef matrix_alg_t::matrix_t							matrix_t;
...
(const PFX_SQE_CMAT_TYPE::cvector_t& vec, const PFX_SQE_CMAT_TYPE::cmatrix_t& mat)
{
	...
	typedef matrix_alg_t::matrix_t							matrix_t;
	typedef matrix_alg_t::vector_t							vector_t;
	cvector_t	retn_vec;
	...
	indentify_replace (PFX_SQEX_CMAT_TYPE::dim_t val)
{
	...
	matrix_alg_t::matrix_ex_t mat = matrix_reference (this->m_mat);
	matrix_alg_t::Indentify_matrix (dim_count, mat, val, 0);
	return *this;
}
	...
	(PFX_SQEX_CMAT_TYPE::cmatrix_ex_t &mat) const
{
	...
	if (&mat != this)
	{
		matrix_alg_t::matrix_ex_t mat_this = matrix_reference (this->m_mat);
		matrix_alg_t::matrix_ex_t mat_other = matrix_reference (mat->m_mat);
		matrix_alg_t::transpose_matrix (dim_count, mat_this, mat_other);
	}
	else
	{
	...
	PFX_SQEX_CMAT_TYPE::cw_buffer_t* exten_buffer)
{
	...
	typedef matrix_alg_t::matrix_ex_t						matrix_ex_t;
