...
typedef struct st_matrix_operate_unsafe_std
{
	...
	// 行优先
#define M11_S1 src1_ptr[ itr ].m_mat[0].m_vec[0]
#define M11_S2 src2_ptr[ itr ].m_mat[0].m_vec[0]
#define M11_D  dst_ptr [ itr ].m_mat[0].m_vec[0]
#define M12_S1 src1_ptr[ itr ].m_mat[0].m_vec[1]
#define M12_S2 src2_ptr[ itr ].m_mat[0].m_vec[1]
#define M12_D  dst_ptr [ itr ].m_mat[0].m_vec[1]
#define M13_S1 src1_ptr[ itr ].m_mat[0].m_vec[2]
#define M13_S2 src2_ptr[ itr ].m_mat[0].m_vec[2]
#define M13_D  dst_ptr [ itr ].m_mat[0].m_vec[2]
#define M14_S1 src1_ptr[ itr ].m_mat[0].m_vec[3]
#define M14_S2 src2_ptr[ itr ].m_mat[0].m_vec[3]
#define M14_D  dst_ptr [ itr ].m_mat[0].m_vec[3]


#define M21_S1 src1_ptr[ itr ].m_mat[1].m_vec[0]
#define M21_S2 src2_ptr[ itr ].m_mat[1].m_vec[0]
#define M21_D  dst_ptr [ itr ].m_mat[1].m_vec[0]
#define M22_S1 src1_ptr[ itr ].m_mat[1].m_vec[1]
#define M22_S2 src2_ptr[ itr ].m_mat[1].m_vec[1]
#define M22_D  dst_ptr [ itr ].m_mat[1].m_vec[1]
#define M23_S1 src1_ptr[ itr ].m_mat[1].m_vec[2]
#define M23_S2 src2_ptr[ itr ].m_mat[1].m_vec[2]
#define M23_D  dst_ptr [ itr ].m_mat[1].m_vec[2]
#define M24_S1 src1_ptr[ itr ].m_mat[1].m_vec[3]
#define M24_S2 src2_ptr[ itr ].m_mat[1].m_vec[3]
#define M24_D  dst_ptr [ itr ].m_mat[1].m_vec[3]

#define M31_S1 src1_ptr[ itr ].m_mat[2].m_vec[0]
#define M31_S2 src2_ptr[ itr ].m_mat[2].m_vec[0]
#define M31_D  dst_ptr [ itr ].m_mat[2].m_vec[0]
#define M32_S1 src1_ptr[ itr ].m_mat[2].m_vec[1]
#define M32_S2 src2_ptr[ itr ].m_mat[2].m_vec[1]
#define M32_D  dst_ptr [ itr ].m_mat[2].m_vec[1]
#define M33_S1 src1_ptr[ itr ].m_mat[2].m_vec[2]
#define M33_S2 src2_ptr[ itr ].m_mat[2].m_vec[2]
#define M33_D  dst_ptr [ itr ].m_mat[2].m_vec[2]
#define M34_S1 src1_ptr[ itr ].m_mat[2].m_vec[3]
#define M34_S2 src2_ptr[ itr ].m_mat[2].m_vec[3]
#define M34_D  dst_ptr [ itr ].m_mat[2].m_vec[3]

#define M41_S1 src1_ptr[ itr ].m_mat[3].m_vec[0]
#define M41_S2 src2_ptr[ itr ].m_mat[3].m_vec[0]
#define M41_D  dst_ptr [ itr ].m_mat[3].m_vec[0]
#define M42_S1 src1_ptr[ itr ].m_mat[3].m_vec[1]
#define M42_S2 src2_ptr[ itr ].m_mat[3].m_vec[1]
#define M42_D  dst_ptr [ itr ].m_mat[3].m_vec[1]
#define M43_S1 src1_ptr[ itr ].m_mat[3].m_vec[2]
#define M43_S2 src2_ptr[ itr ].m_mat[3].m_vec[2]
#define M43_D  dst_ptr [ itr ].m_mat[3].m_vec[2]
#define M44_S1 src1_ptr[ itr ].m_mat[3].m_vec[3]
#define M44_S2 src2_ptr[ itr ].m_mat[3].m_vec[3]
#define M44_D  dst_ptr [ itr ].m_mat[3].m_vec[3]


	PFX_FORCE_INLINE MATRIX2F_t* dot_row_first
		(MATRIX2F_t* PFX_RESTRICT PARAM_INOUT dst_ptr,
		MATRIX2F_t* PFX_RESTRICT PARAM_INOUT src1_ptr,
		MATRIX2F_t* PFX_RESTRICT PARAM_INOUT src2_ptr,
		usize__t mat_count)
	{


		for (uindex_t itr = mat_count; itr != 0;)
		{
			--itr;
	...
	PFX_FORCE_INLINE MATRIX3F_t* dot_row_first
		(MATRIX3F_t* PFX_RESTRICT PARAM_INOUT dst_ptr,
		MATRIX3F_t* PFX_RESTRICT PARAM_INOUT src1_ptr,
		MATRIX3F_t* PFX_RESTRICT PARAM_INOUT src2_ptr,
		usize__t mat_count)
	{
		for (uindex_t itr = mat_count; itr != 0;)
		{
	...
	PFX_FORCE_INLINE MATRIX4F_t* dot_row_first
		(MATRIX4F_t* PFX_RESTRICT PARAM_INOUT dst_ptr,
		MATRIX4F_t* PFX_RESTRICT PARAM_INOUT src1_ptr,
		MATRIX4F_t* PFX_RESTRICT PARAM_INOUT src2_ptr,
		usize__t mat_count)
	{
		for (uindex_t itr = mat_count; itr != 0;)
		{
...
#define M11_D dst_ptr->m_mat[0].m_vec[0]
#define M12_D dst_ptr->m_mat[0].m_vec[1]
#define M13_D dst_ptr->m_mat[0].m_vec[2]
#define M14_D dst_ptr->m_mat[0].m_vec[3]
#define M21_D dst_ptr->m_mat[1].m_vec[0]
#define M22_D dst_ptr->m_mat[1].m_vec[1]
#define M23_D dst_ptr->m_mat[1].m_vec[2]
#define M24_D dst_ptr->m_mat[1].m_vec[3]
#define M31_D dst_ptr->m_mat[2].m_vec[0]
#define M32_D dst_ptr->m_mat[2].m_vec[1]
#define M33_D dst_ptr->m_mat[2].m_vec[2]
#define M34_D dst_ptr->m_mat[2].m_vec[3]
#define M41_D dst_ptr->m_mat[3].m_vec[0]
#define M42_D dst_ptr->m_mat[3].m_vec[1]
#define M43_D dst_ptr->m_mat[3].m_vec[2]
#define M44_D dst_ptr->m_mat[3].m_vec[3]
		...
		usize__t mat_count)
	{
		...
		M21_D = M21_S1;
		M22_D = M22_S1;
		for (itr = 1; itr < mat_count; ++itr)
		{
			dot_row_first(dst_ptr, dst_ptr, src1_ptr, 1);
		}
		return dst_ptr;
	}
...
#define M11_S2 src2_ptr[ itr ].m_mat[0].m_vec[0]
#define M11_D  dst_ptr [ itr ].m_mat[0].m_vec[0]
#define M12_S1 src1_ptr[ itr ].m_mat[1].m_vec[0]
#define M12_S2 src2_ptr[ itr ].m_mat[1].m_vec[0]
#define M12_D  dst_ptr [ itr ].m_mat[1].m_vec[0]
#define M13_S1 src1_ptr[ itr ].m_mat[2].m_vec[0]
#define M13_S2 src2_ptr[ itr ].m_mat[2].m_vec[0]
#define M13_D  dst_ptr [ itr ].m_mat[2].m_vec[0]
#define M14_S1 src1_ptr[ itr ].m_mat[3].m_vec[0]
#define M14_S2 src2_ptr[ itr ].m_mat[3].m_vec[0]
#define M14_D  dst_ptr [ itr ].m_mat[3].m_vec[0]


#define M21_S1 src1_ptr[ itr ].m_mat[0].m_vec[1]
#define M21_S2 src2_ptr[ itr ].m_mat[0].m_vec[1]
#define M21_D  dst_ptr [ itr ].m_mat[0].m_vec[1]
#define M22_S1 src1_ptr[ itr ].m_mat[1].m_vec[1]
#define M22_S2 src2_ptr[ itr ].m_mat[1].m_vec[1]
#define M22_D  dst_ptr [ itr ].m_mat[1].m_vec[1]
#define M23_S1 src1_ptr[ itr ].m_mat[2].m_vec[1]
#define M23_S2 src2_ptr[ itr ].m_mat[2].m_vec[1]
#define M23_D  dst_ptr [ itr ].m_mat[2].m_vec[1]
#define M24_S1 src1_ptr[ itr ].m_mat[3].m_vec[1]
#define M24_S2 src2_ptr[ itr ].m_mat[3].m_vec[1]
#define M24_D  dst_ptr [ itr ].m_mat[3].m_vec[1]

#define M31_S1 src1_ptr[ itr ].m_mat[0].m_vec[2]
#define M31_S2 src2_ptr[ itr ].m_mat[0].m_vec[2]
#define M31_D  dst_ptr [ itr ].m_mat[0].m_vec[2]
#define M32_S1 src1_ptr[ itr ].m_mat[1].m_vec[2]
#define M32_S2 src2_ptr[ itr ].m_mat[1].m_vec[2]
#define M32_D  dst_ptr [ itr ].m_mat[1].m_vec[2]
#define M33_S1 src1_ptr[ itr ].m_mat[2].m_vec[2]
#define M33_S2 src2_ptr[ itr ].m_mat[2].m_vec[2]
#define M33_D  dst_ptr [ itr ].m_mat[2].m_vec[2]
#define M34_S1 src1_ptr[ itr ].m_mat[3].m_vec[2]
#define M34_S2 src2_ptr[ itr ].m_mat[3].m_vec[2]
#define M34_D  dst_ptr [ itr ].m_mat[3].m_vec[2]

#define M41_S1 src1_ptr[ itr ].m_mat[0].m_vec[3]
#define M41_S2 src2_ptr[ itr ].m_mat[0].m_vec[3]
#define M41_D  dst_ptr [ itr ].m_mat[0].m_vec[3]
#define M42_S1 src1_ptr[ itr ].m_mat[1].m_vec[3]
#define M42_S2 src2_ptr[ itr ].m_mat[1].m_vec[3]
#define M42_D  dst_ptr [ itr ].m_mat[1].m_vec[3]
#define M43_S1 src1_ptr[ itr ].m_mat[2].m_vec[3]
#define M43_S2 src2_ptr[ itr ].m_mat[2].m_vec[3]
#define M43_D  dst_ptr [ itr ].m_mat[2].m_vec[3]
#define M44_S1 src1_ptr[ itr ].m_mat[3].m_vec[3]
#define M44_S2 src2_ptr[ itr ].m_mat[3].m_vec[3]
#define M44_D  dst_ptr [ itr ].m_mat[3].m_vec[3]

	PFX_FORCE_INLINE MATRIX2F_t* dot_col_first
		(MATRIX2F_t* PFX_RESTRICT PARAM_INOUT dst_ptr,
		MATRIX2F_t* PFX_RESTRICT PARAM_INOUT src1_ptr,
		MATRIX2F_t* PFX_RESTRICT PARAM_INOUT src2_ptr,
		usize__t mat_count)
	...
	PFX_FORCE_INLINE MATRIX3F_t* dot_col_first
		(MATRIX3F_t* PFX_RESTRICT PARAM_INOUT dst_ptr,
		MATRIX3F_t* PFX_RESTRICT PARAM_INOUT src1_ptr,
		MATRIX3F_t* PFX_RESTRICT PARAM_INOUT src2_ptr,
		usize__t mat_count)
	...
	PFX_FORCE_INLINE MATRIX4F_t* dot_col_first
		(MATRIX4F_t* PFX_RESTRICT PARAM_INOUT dst_ptr,
		MATRIX4F_t* PFX_RESTRICT PARAM_INOUT src1_ptr,
		MATRIX4F_t* PFX_RESTRICT PARAM_INOUT src2_ptr,
		usize__t mat_count)
...
#define M11_D dst_ptr->m_mat[0].m_vec[0]
#define M12_D dst_ptr->m_mat[1].m_vec[0]
#define M13_D dst_ptr->m_mat[2].m_vec[0]
#define M14_D dst_ptr->m_mat[3].m_vec[0]
#define M21_D dst_ptr->m_mat[0].m_vec[1]
#define M22_D dst_ptr->m_mat[1].m_vec[1]
#define M23_D dst_ptr->m_mat[2].m_vec[1]
#define M24_D dst_ptr->m_mat[3].m_vec[1]
#define M31_D dst_ptr->m_mat[0].m_vec[2]
#define M32_D dst_ptr->m_mat[1].m_vec[2]
#define M33_D dst_ptr->m_mat[2].m_vec[2]
#define M34_D dst_ptr->m_mat[3].m_vec[2]
#define M41_D dst_ptr->m_mat[1].m_vec[3]
#define M42_D dst_ptr->m_mat[2].m_vec[3]
#define M43_D dst_ptr->m_mat[3].m_vec[3]
#define M44_D dst_ptr->m_mat[3].m_vec[3]
